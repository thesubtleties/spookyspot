Here's the clean version - copy this directly:

# SpookySpot 🏚️👻

SpookySpot is a full-stack Airbnb-inspired web application focused on haunted locations. Users can discover, book, and review allegedly haunted properties, complete with atmospheric imagery generated by Midjourney v6.1.

[Live Demo](https://spookyspot.sbtl.dev)

![SpookySpot Screenshot](https://storage.sbtl.dev/spookyspot/spookyspot.webp)
...
This project was developed as part of the App Academy curriculum. While it's primarily a portfolio piece, suggestions and feedback are welcome.
...
- Property images generated using Midjourney v6.1
